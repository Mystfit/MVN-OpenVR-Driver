...
MocapDriver::HMDDevice::HMDDevice(std::string serial):serial_(serial)
{
}

std::string MocapDriver::HMDDevice::GetSerial()
{
    return this->serial_;
}

void MocapDriver::HMDDevice::Update()
{
...
DeviceType MocapDriver::HMDDevice::GetDeviceType()
{
    return DeviceType::HMD;
}

vr::TrackedDeviceIndex_t MocapDriver::HMDDevice::GetDeviceIndex()
{
    return this->device_index_;
}

vr::EVRInitError MocapDriver::HMDDevice::Activate(uint32_t unObjectId)
{
...
void MocapDriver::HMDDevice::Deactivate()
{
    this->device_index_ = vr::k_unTrackedDeviceIndexInvalid;
}

void MocapDriver::HMDDevice::EnterStandby()
{
}

void* MocapDriver::HMDDevice::GetComponent(const char* pchComponentNameAndVersion)
{
...
void MocapDriver::HMDDevice::DebugRequest(const char* pchRequest, char* pchResponseBuffer, uint32_t unResponseBufferSize)
{
    if (unResponseBufferSize >= 1)
        pchResponseBuffer[0] = 0;
}

vr::DriverPose_t MocapDriver::HMDDevice::GetPose()
{
    return this->last_pose_;
}

void MocapDriver::HMDDevice::GetWindowBounds(int32_t* pnX, int32_t* pnY, uint32_t* pnWidth, uint32_t* pnHeight)
{
    *pnX = this->window_x_;
    *pnY = this->window_y_;
...
bool MocapDriver::HMDDevice::IsDisplayOnDesktop()
{
    return true;
}

bool MocapDriver::HMDDevice::IsDisplayRealDisplay()
{
    return false;
}

void MocapDriver::HMDDevice::GetRecommendedRenderTargetSize(uint32_t* pnWidth, uint32_t* pnHeight)
{
    *pnWidth = this->window_width_;
    *pnHeight = this->window_height_;
}

void MocapDriver::HMDDevice::GetEyeOutputViewport(vr::EVREye eEye, uint32_t* pnX, uint32_t* pnY, uint32_t* pnWidth, uint32_t* pnHeight)
{
    *pnY = 0;
...
void MocapDriver::HMDDevice::GetProjectionRaw(vr::EVREye eEye, float* pfLeft, float* pfRight, float* pfTop, float* pfBottom)
{
    *pfLeft = -1;
    *pfRight = 1;
    *pfTop = -1;
...
vr::DistortionCoordinates_t MocapDriver::HMDDevice::ComputeDistortion(vr::EVREye eEye, float fU, float fV)
{
